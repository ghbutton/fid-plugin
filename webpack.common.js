...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({ template: 'src/popup/index.html', filename: "popup/index.html", chunks: ["popup"] }),
    new HtmlWebpackPlugin({ filename: "background.html", chunks: ["background"] }),
